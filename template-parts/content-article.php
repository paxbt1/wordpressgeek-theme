                    ...
                    <div class="col-md-6">
                        <div class="entry-meta align-items-center meta-2 font-small color-muted">
                            <p class="mb-5">
                                ...
                                <?php echo _e('By','wordpressgeek') ?> <span class="author-name font-weight-bold"><?php the_author_nickname(); ?></span>
                            </p>
                            ...
                            <li class="mb-30">
                                <div class="d-flex hover-up-2 transition-normal">
                                    <div
                                        ...
                                        <a class="color-white"
                                            href="https://stories.botble.com/sexy-clutches-how-to-buy-wear-a-designer-clutch-bag">
                                            <img src="https://stories.botble.com/storage/news/16.jpg"
                                                alt="Sexy Clutches: How to Buy &amp; Wear a Designer Clutch Bag">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-15 text-limit-2-row font-medium"><a
                                                href="https://stories.botble.com/sexy-clutches-how-to-buy-wear-a-designer-clutch-bag">Sexy
                                                Clutches: How to Buy &amp; Wear a Designer Clutch Bag</a></h6>
                                        <div class="entry-meta meta-1 float-left font-x-small text-uppercase">
                                            <span class="post-on">Aug 08, 2021</span>
                                            <span class="post-by has-dot">1,566 views</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="mb-30">
                                <div class="d-flex hover-up-2 transition-normal">
                                    <div
                                        class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                                        <a class="color-white"
                                            href="https://stories.botble.com/which-company-would-you-choose">
                                            <img src="https://stories.botble.com/storage/news/3.jpg"
                                                alt="Which Company Would You Choose?">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-15 text-limit-2-row font-medium"><a
                                                href="https://stories.botble.com/which-company-would-you-choose">Which
                                                Company Would You Choose?</a></h6>
                                        <div class="entry-meta meta-1 float-left font-x-small text-uppercase">
                                            <span class="post-on">Aug 08, 2021</span>
                                            <span class="post-by has-dot">890 views</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
